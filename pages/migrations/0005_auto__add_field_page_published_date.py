...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.published_date'
        db.add_column(u'pages_page', 'published_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.published_date'
        db.delete_column(u'pages_page', 'published_date')
